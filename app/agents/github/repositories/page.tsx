      ...
      <Card className="bg-gray-900 border-gray-800">
        <CardHeader className="pb-2">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <CardTitle className="text-xl text-emerald-400">Repositories</CardTitle>
        ...
        <CardContent>
          <div className="text-center py-12 text-gray-500">
            ...
            <h3 className="text-lg font-medium text-gray-300 mb-2">Repositories will be displayed here</h3>
            <p className="max-w-md mx-auto">
              This page will show all GitHub repositories managed by the GitHub Manager agent.
            </p>
          </div>
        </CardContent>
      </Card>
